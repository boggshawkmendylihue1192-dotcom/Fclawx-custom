...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'xai', name: 'xAI', icon: 'X', placeholder: 'xai-...', model: 'Grok', requiresApiKey: true, isOAuth: true, supportsApiKey: true, defaultBaseUrl: 'https://api.x.ai/v1', showModelId: true, modelIdPlaceholder: 'grok-4.3', defaultModelId: 'grok-4.3', apiKeyUrl: 'https://console.x.ai/', docsUrl: 'https://docs.x.ai/' },
